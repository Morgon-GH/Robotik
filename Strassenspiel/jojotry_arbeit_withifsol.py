        ...
        if level==0:
            ...
            while not (Button.CENTER in self.buttons.pressed()):
                ...
                if (int(time.perf_counter()-starttime)>(tempo*tempo_)):
                    self.l.tempo=random(1, 200); self.m.tempo=random(1, 200); self.r.tempo=random(1, 200); tempo_=tempo_+1
            ...
            while not (Button.CENTER in self.buttons.pressed()):
                ...
                self.screen.print("Dein Score ist: " +str(int((time.perf_counter()-starttime)*100)))
                if (int(time.perf_counter()-starttime)>(tempo)):
                    self.l.tempo=random(1, 200); self.m.tempo=random(1, 200); self.r.tempo=random(1, 200); tempo=randint(3, 7)+int(time.perf_counter()-starttime)
                elif (int(time.perf_counter()-starttime)>(tempo*tempo_)):
                    pass
